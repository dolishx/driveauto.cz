...
export function CarSilhouette({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 320 72" className={className} aria-hidden="true" preserveAspectRatio="xMinYMid meet">
      <path
      ...
      />
      <path
        d="M232 52C242 36 270 36 281 52"
        fill="none"
        stroke="#1E40AF"
        strokeLinecap="round"
        strokeWidth="5.2"
